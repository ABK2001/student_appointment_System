...
if (isset ( $_POST ['btn-submit'] )) {
	...
	if (mysqli_query ($con,  "UPDATE faculty_member SET first_name = '$first_name', last_name = '$last_name', username = '$username', email = '$email', password = '$password', mobile = '$mobile', gender = '$gender', age = '$age', speciality = '$speciality', department = '$department' WHERE id = $_SESSION[user_id]" )) {
...
$query = "SELECT * FROM faculty_member WHERE id = $_SESSION[user_id]";
