<?php $page_title = "Approve Appointment"; ?>
...
// Update status
mysqli_query($con, "UPDATE appointment SET status = 'Approved' WHERE id = '$appointment_id'");

// Send notification
$notif_content = "Your appointment has been <strong>approved</strong> by the faculty member.";
...
echo "<script>alert('Appointment approved and student notified.');</script>";
